...
var Slider = function (_React$Component) {
  ...
  Slider.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    if (this.props.onOldValueOutOfRange && __WEBPACK_IMPORTED_MODULE_5__utils__["i" /* isValueOutOfRange */](value, nextProps)) {
...
var Range = function (_React$Component) {
  ...
  Range.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    if (this.props.onOldValueOutOfRange && bounds.some(function (v) {
      return __WEBPACK_IMPORTED_MODULE_7__utils__["i" /* isValueOutOfRange */](v, nextProps);
    })) {
      this.props.onOldValueOutOfRange(bounds, nextBounds);
    }
  };
